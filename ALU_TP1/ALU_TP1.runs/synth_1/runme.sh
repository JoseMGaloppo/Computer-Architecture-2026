...
HD_PWD='C:/Users/Jose/TPs/Computer-Architecture-2026/ALU_TP1/ALU_TP1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_alu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_alu_top.tcl
