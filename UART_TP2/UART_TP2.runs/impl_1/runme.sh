...
HD_PWD='C:/Users/Jose/TPs/Computer-Architecture-2026/UART_TP2/UART_TP2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_alu_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_alu_system_top.tcl -notrace
