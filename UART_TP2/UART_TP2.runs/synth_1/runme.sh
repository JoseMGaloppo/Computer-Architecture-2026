...
HD_PWD='C:/Users/Jose/TPs/Computer-Architecture-2026/UART_TP2/UART_TP2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_alu_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_alu_system_top.tcl
